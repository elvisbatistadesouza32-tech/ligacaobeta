            ...
            <div className="text-center space-y-4">
              ...
              <div className="pt-4 border-t space-y-3">
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <button onClick={() => handleStatusSelect(CallStatus.NO_ANSWER)} className="flex items-center justify-center gap-2 w-full py-4 bg-red-500 text-white rounded-xl font-bold active:scale-95 transition-all"><XCircle className="w-5 h-5" /> Não atendeu</button>
                  <button onClick={() => handleStatusSelect(CallStatus.INVALID_NUMBER)} className="flex items-center justify-center gap-2 w-full py-4 bg-orange-500 text-white rounded-xl font-bold active:scale-95 transition-all"><AlertTriangle className="w-5 h-5" /> Número Inválido</button>
                </div>
              </div>
            </div>
          </div>
