...
export const Layout: React.FC<LayoutProps> = ({ user, onLogout, children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50/50">
      ...
      <footer className="py-12 text-center flex flex-col items-center gap-3">
        <div className="text-gray-400 text-[10px] font-black uppercase tracking-[0.3em] opacity-70">
          &copy; 2025 LIGAÇÕES PORTAL • GESTÃO COMERCIAL DE ALTA PERFORMANCE
        </div>
        <div className="flex items-center gap-3">
          <div className="h-[1px] w-8 bg-gray-200" />
          <div className="text-slate-900 text-[11px] font-black uppercase tracking-widest italic">
